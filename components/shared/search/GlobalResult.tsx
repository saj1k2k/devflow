    ...
    return (
        <div className='absolute top-full z-10 mt-3 w-full bg-light-800 py-5 shadow-sm dark:bg-dark-400 rounded-xl'>
            ...
            <div className="space-y-5">
                ...
                {isLoading ? (
                    <div
                        className='flex-center flex-col px-5'
                    ><ReloadIcon
                    ...
                    <div className='flex flex-col gap-2'>
                        {result.length > 0 ? (
                            result.map((item: any, index: number) => (
                                ...
                                >
                                    <Image src='/assets/icons/tag.svg' alt='tags'
                                    width={18} height={18} className='invert-colors mt-1 object-contain'/>
                            ...
                            <div className='flex-center px-5 flex-col'><p className=
                            'text-dark200_light800 body-regular px-5 py-2.5'>Oops, no result found</p></div>
                        )}
                    </div>
                )}
            </div>
