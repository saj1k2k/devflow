            ...
            <SignedOut>
                <div className="flex flex-col gap-3">
                    ...
                    min-h-[41px] w-full rounded-lg px-4 py-3 shadow-none"
                            >
                                <Image className='invert-colors lg:hidden' src='/assets/icons/account.svg' alt='login' width={20} height={20}/>
                    ...
                    min-h-[41px] w-full rounded-lg px-4 py-3 shadow-none"
                            >
                                <Image className='invert-colors lg:hidden' src='/assets/icons/sign-up.svg' alt='sign-up' width={20} height={20}/>
